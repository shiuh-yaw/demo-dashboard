  ...
  return (
    <div className="rise">
            ...
            {state.positions.map((p) => (
              <li key={p.id} className="flex items-center gap-4 px-5 py-3.5 border-b border-line last:border-0">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[12px] text-muted">Opened {relTime(p.openedAt)} · from your Exchange account, signed on your device</div>
                </div>
                <div className="text-right">
      ...
      <p className="mt-6 text-[12px] text-muted">
        Earn is available for stablecoins on EVM networks today. Solana and Tron are on the roadmap for H2 2026. Your funds stay in a wallet only you control; Exchange never holds them.
      </p>
