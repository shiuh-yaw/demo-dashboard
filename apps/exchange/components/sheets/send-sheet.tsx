...
export const DEMO_RECIPIENT = { name: "Kopi & Co.", role: "Merchant · Exchange Pay", address: addressFor("exchange:recipient:kopi-merchant") };
        ...
        <div className="text-center py-4 rise">
          ...
          <div className="mt-4 rounded-xl bg-ground p-3.5 text-[13px] text-left space-y-1.5">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{sponsored ? "Sponsored by Exchange" : "Paid from balance"}</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="rounded-xl bg-ground p-3.5 text-[13px] space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="flex items-center gap-2">
                ...
                <Badge tone="brand">Sponsored by Exchange</Badge>
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted">Your ETH balance</span>
            ...
            <p className="text-[12px] text-muted pt-1 border-t border-line">
              You hold no ETH and do not need any. The fee is paid by Exchange's relayer (EIP-7702). Enterprise feature, provisioned per environment.
            </p>
          </div>
