  ...
  return (
    <Sheet open={open} onClose={onClose} title="Earn on your dollars">
      <div className="space-y-4">
        ...
        {state.mode === "live" && <p className="text-[12px] text-info">Live mode: the position is recorded in Exchange's ledger for this build; the Earn API is wired server-side in production.</p>}
