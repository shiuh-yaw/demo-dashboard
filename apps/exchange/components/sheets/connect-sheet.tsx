      ...
      <Sheet open={open} onClose={onClose} title="Confirm it's you">
        ...
        >
          <p className="text-[14px] text-ink-2">
            Adding a wallet changes how this account can be used, so Exchange re-checks it's you first. Enter the code sent to <span className="font-medium text-ink">{stepUp.email}</span>.
          </p>
