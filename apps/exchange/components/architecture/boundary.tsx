    ...
    <div className="space-y-4">
      <div className="grid md:grid-cols-2 gap-4">
        <Card className="border-ink/20">
          ...
          <h3 className="text-lg font-bold mt-1">Exchange's own money</h3>
        ...
        <Card className="border-brand/40">
          ...
          <p className="text-[13px] text-muted mt-1">One wallet per user, inside the Exchange app, keys the user holds a share of.</p>
          <ul className="mt-4 text-[13px] space-y-1.5 list-disc pl-4 text-ink-2">
