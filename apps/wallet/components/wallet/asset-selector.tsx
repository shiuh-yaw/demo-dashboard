            ...
            <>
              {assets.map((token) => (
                ...
                >
                  {token.logoURI ? (
                    ...
                    <div className="w-5 h-5 rounded-full bg-(--brand-border) flex items-center justify-center">
                      <Coins className="w-3 h-3 text-(--brand-muted)" />
                    </div>
                  )}
                  <span className="flex-1 min-w-0 text-left text-xs font-medium text-(--brand-fg) truncate">
                    {token.symbol}
                  </span>
              ...
              {onManualEntry && (
                <button
                  ...
                  className="w-full flex items-center gap-2 px-2.5 py-2 hover:bg-(--brand-row-hover) transition-colors cursor-pointer text-(--brand-muted) hover:text-(--brand-fg)"
                >
                  <div className="w-5 h-5 rounded-full bg-(--brand-border) flex items-center justify-center">
