 ...
 * SDK (migration is a tracked follow-up in AGENTS.md).
 */
...
export const TRADE_SDK_STEPS: StepSource[] = [
  {
    num: "01",
...
const walletAccount = walletAccounts?.[0];`,
  ...
  },
  {
    ...
    filename: "lib/trade/execute-swap.ts",
    lang: "typescript",
...
export const TRADE_OTP_STEPS: StepSource[] = [
  {
    num: "01",
...
verifyOtp({ otp: code, otpVerification });`,
  ...
  },
  {
    ...
    prose:
      "With the session live, one call mints the user's non-custodial embedded (WaaS) wallet - no extension, no seed phrase - and they land in the app ready to trade.",
    filename: "lib/dynamic/wallets.ts",
    lang: "typescript",
    code: `import { createWaasWalletAccounts } from "@dynamic-labs-sdk/client/waas";
