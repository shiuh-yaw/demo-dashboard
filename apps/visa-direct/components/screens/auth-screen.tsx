...
/**
 * Authentication screen — uses the shared LoginForm from packages/ui.
 *
 * Keeps a `navigation` prop shape consistent with the other demos
 * (trade, remittance) so screen-to-screen wiring stays copy-paste friendly.
 *
