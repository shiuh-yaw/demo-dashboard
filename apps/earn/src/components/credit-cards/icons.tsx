...
// Card logo utility function
export type CardType = "visa" | "mastercard";
export type CardColorVariant = "color" | "white";
...
export const getCardLogo = (
  ...
  if (cardType === "visa") {
    return colorVariant === "color" ? VisaIcon : VisaIconWhite;
  } else {
    return colorVariant === "color" ? MastercardIcon : MastercardIconWhite;
  }
};
