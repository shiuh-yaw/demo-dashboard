    ...
    <Sheet open={open} onClose={onClose} title="Add funds">
      {backend.canFaucet ? (
        <div className="space-y-5">
          <p className="text-[14px] text-ink-2">Choose an amount. Testnet funds arrive from the Rimau faucet in a few seconds.</p>
        ...
        <div className="space-y-5">
          <p className="text-[14px] text-ink-2">Send Sepolia USDC to your Rimau account. The balance updates by itself once it lands.</p>
