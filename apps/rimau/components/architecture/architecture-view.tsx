    ...
    <>
      ...
      <Card>
        ...
        <ol className="mt-3 space-y-2 text-[13px] text-ink-2 list-decimal pl-4">
          ...
          <li>Rimau's systems hold session tokens and a ledger. No key material, so no custody.</li>
...
const THREATS: { id: Threat; label: string; reaches: string[]; not: string[]; verdict: string }[] = [
  {
    id: "rimau-db",
    label: "Attacker inside Rimau's database",
  ...
  {
    id: "insider",
    label: "Malicious insider at Rimau",
