...
/**
 * The demo script, as presenter cues. Condensed from Brief 04 (Rimau Exchange)
...
export const BEATS: BeatCue[] = [
  {
    ...
    say: "Nothing in that flow said the word wallet. There is now a non-custodial 2-of-2 wallet on this device, and Rimau cannot move the funds in it.",
  ...
  },
  {
    ...
    say: "This is the retention answer made concrete. The activity that was walking out the door to MetaMask happens here, on Rimau's screen, in Rimau's session.",
  ...
  },
  {
    ...
    watch: "Nobody types twelve words. Rimau never held a key. Point at the identical address only after the restore completes.",
    doneWhen: "Recovered on device B.",
  },
  {
    beat: 5,
    title: "The 2-of-2 split, and what a breach reaches",
    show: "Architecture view, live, with this session's wallet on it. Then colour in the blast radius: Rimau's database, Dynamic's infrastructure, an insider.",
...
export const BOUNDARIES: Boundary[] = [
  ...
  },
  {
    ...
    boundary: "No seed phrase at any point. Rimau never holds a key.",
  },
  {
...
export const TRAP_QUESTIONS = [
  ...
  "Where does Fireblocks end and Dynamic begin: Fireblocks vault for Rimau's treasury, Dynamic for the three million end-user wallets.",
