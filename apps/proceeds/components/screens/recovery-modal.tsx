    ...
    >
      <div className="bg-(--widget-bg) rounded-(--widget-radius-lg) shadow-xl w-full max-w-md">
        <div className="p-8 text-center">
          <div className="w-12 h-12 rounded-full bg-(--widget-primary)/10 flex items-center justify-center mx-auto mb-4">
            <UserPlus className="w-5 h-5 text-(--widget-primary)" />
          </div>
          <h2 className="text-lg font-semibold text-(--widget-fg) mb-2">
            Recovery contact
          </h2>
          <p className="text-sm text-(--widget-muted) mb-6 leading-relaxed">
