/**
 * Deterministic Prospect id derivation + small hex helpers.
 *
 * Re-running the backfill must not create duplicate Prospect rows for
 * the same logical prospect. We derive the id from a stable subset of
