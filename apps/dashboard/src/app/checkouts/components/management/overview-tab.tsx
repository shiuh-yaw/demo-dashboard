        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          >
            ...
            <Link
              ...
              className="relative overflow-hidden rounded-lg bg-linear-to-br from-emerald-50 to-emerald-100/50 p-4 border border-emerald-200/50 hover:border-emerald-300 hover:shadow-sm transition-all cursor-pointer group"
            >
            ...
            <Link
              ...
              className="relative overflow-hidden rounded-lg bg-linear-to-br from-blue-50 to-blue-100/50 p-4 border border-blue-200/50 hover:border-blue-300 hover:shadow-sm transition-all cursor-pointer group"
            >
              <div className="flex items-center justify-between mb-2">
            ...
            <Link
              ...
              className="relative overflow-hidden rounded-lg bg-linear-to-br from-red-50 to-red-100/50 p-4 border border-red-200/50 hover:border-red-300 hover:shadow-sm transition-all cursor-pointer group"
            >
              <div className="flex items-center justify-between mb-2">
