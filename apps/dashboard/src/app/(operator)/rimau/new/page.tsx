...
import { createRimauConfig } from "@/lib/actions/rimau";
...
import type { RimauConfig } from "@/lib/types/dashboard";

export default function NewRimauConfigPage() {
  ...
  const [appName, setAppName] = useState("Rimau");
  ...
  async function handleCreate() {
    ...
    try {
      ...
      const result = await createRimauConfig(name.trim(), config, prospectId);

      if (result.success) {
        router.push(`/rimau/${result.data.id}`);
      } else {
