/**
 * New Prospect Profile Page
 *
 * Form for creating a new prospect profile.
...
import type { ProspectTheme } from "@/lib/types/dashboard";

export default function NewProspectProfilePage() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.error || "Failed to create prospect profile");
      }
    } catch (err) {
      setError("Failed to create prospect profile");
      console.error(err);
    } finally {
      setIsCreating(false);
    }
