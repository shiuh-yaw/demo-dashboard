...
/**
 * AI Style Import for Prospect Profiles
 *
...
interface ExtractedProspectTheme {
  primaryColor?: string;
  accentColor?: string;
...
interface AiStyleImportProps {
  initialUrl?: string;
  onImport: (theme: ExtractedProspectTheme) => void;
...
export function AiStyleImport({
  ...
  async function handleImportFromUrl() {
    ...
    try {
      ...
      // Map the widget theme to prospect settings
      const extractedTheme: ExtractedProspectTheme = {
